...
;; zenburn (muted, colorful; lighter background, still light-on-dark)
;; ir-black (excellent and legible)
;; molokai (bold, light-on-dark)
;; ample (very much like molokai, but more muted - very pretty)
;; leuven (light, with bright colors)
;; eink (interesting beiges)
