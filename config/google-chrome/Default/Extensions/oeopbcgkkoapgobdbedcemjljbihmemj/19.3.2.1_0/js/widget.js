		...
		$.each(accounts, function(index, account) {
			...
			if (true) { //account.unreadCount
				...
				$.each(account.emails, function(emailIndex, email) {
					...
					;
					$email.find(".author").text(email.authorName);
					$email.find(".date").text(email.dateFormatted);
					$email.find(".subject").text(email.title);
					$email.find(".summary").text(email.summary);
